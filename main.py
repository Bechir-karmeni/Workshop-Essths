...
HEADER_FONT = pygame.font.Font(None, 55)
SCRIPT_FONT = pygame.font.Font(None, 80)
...
def clear_screen():
    """Clears the screen and redraws the UI elements."""
    DISPLAYSURF.fill(WHITE)
    DISPLAYSURF.blit(LOGO, (50, 50))
    pygame.draw.rect(DISPLAYSURF, BORDER_COLOR, (50, 170, WINDOWSIZEX - 100, WINDOWSIZEY - 300), border_radius=10)
    pygame.draw.rect(DISPLAYSURF, BOX_COLOR, (55, 175, WINDOWSIZEX - 110, WINDOWSIZEY - 310), border_radius=10)
    text_instructions()

def text_instructions():
    """Displays the instructional text on the screen."""
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == MOUSEMOTION and iswriting:
            ...
            if 80 < xcord < 770 and 180 < ycord < 570:
